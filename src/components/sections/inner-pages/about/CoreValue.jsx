const CoreValue = () => {
  return (
    <section id='core-value '>
      {/* Section Spacer */}
      <div className='jos mx-5 pb-10 rounded-[50px] bg-black px-[20px] py-20 sm:px-[50px] md:mx-[50px] lg:px-[100px] xl:py-[130px]'>
        {/* Section Container */}
        <div className='global-container'>
          {/* Section Content Block */}
          <div className='mb-10 text-center lg:mb-12 xl:mb-20'>
            <div className='mx-auto md:max-w-xl lg:max-w-3xl xl:max-w-[745px]'>
              <h2 className='text-white'>Innovation is our DNA</h2>
            </div>
          </div>
          {/* Section Content Block */}
          ...
          <ul className='grid grid-cols-1 justify-between gap-6 md:grid-cols-2 xxl:flex xxl:flex-nowrap'>
            ...
            <li className='relative after:absolute after:-top-[3px] after:left-0 after:h-[5px] after:w-full after:scale-x-0 after:rounded-[5px] after:bg-colorOrangyRed after:transition-all after:duration-300 hover:after:scale-x-0 sm:pt-6 lg:pt-10 xxl:hover:after:scale-x-100'>
              ...
              <p className='text-lg text-white lg:text-[21px]'>
                We’re committed to bringing the best of AI to the supply chain.
              </p>
            </li>
            {/* Core Value Item */}
            {/* Core Value Item */}
            <li className='relative after:absolute after:-top-[3px] after:left-0 after:h-[5px] after:w-full after:scale-x-0 after:rounded-[5px] after:bg-colorOrangyRed after:transition-all after:duration-300 hover:after:scale-x-0 sm:pt-6 lg:pt-10 xxl:hover:after:scale-x-100'>
              ...
              <p className='text-lg text-white lg:text-[21px]'>
                We are dedicated to delivering the best possible solutions.
              </p>
            </li>
            {/* Core Value Item */}
            {/* Core Value Item */}
            <li className='relative after:absolute after:-top-[3px] after:left-0 after:h-[5px] after:w-full after:scale-x-0 after:rounded-[5px] after:bg-colorOrangyRed after:transition-all after:duration-300 hover:after:scale-x-0 sm:pt-6 lg:pt-10 xxl:hover:after:scale-x-100'>
              ...
              <p className='text-lg text-white lg:text-[21px]'>
                We believe in the power of collaboration in Supply chains.
              </p>
            </li>
            {/* Core Value Item */}
            {/* Core Value Item */}
            <li className='relative after:absolute after:-top-[3px] after:left-0 after:h-[5px] after:w-full after:scale-x-0 after:rounded-[5px] after:bg-colorOrangyRed after:transition-all after:duration-300 hover:after:scale-x-0 sm:pt-6 lg:pt-10 xxl:hover:after:scale-x-100'>
              ...
              <p className='text-lg text-white lg:text-[21px]'>
                We are commited to use AI in a way that is ethical and transparent.
              </p>
            </li>
            {/* Core Value Item */}
          </ul>
