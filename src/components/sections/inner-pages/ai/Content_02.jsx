        ...
        <div className='global-container'>
          ...
          <div className='jos mb-10 text-center lg:mb-16 xl:mb-20'>
            <div className='font-spaceGrotesk mx-auto md:max-w-xl lg:max-w-4xl xl:max-w-[950px]'>
              <h2>No more manual communications and data errors!</h2>
            </div>
          </div>
          {/* Section Content Block */}
          <div className='grid grid-cols-1 items-center gap-12 md:grid-cols-[minmax(0,_1fr)_1.2fr] xl:gap-28 xxl:gap-32'>
            ...
            >
              <ul className='flex flex-col gap-y-6'>
                <li>
                  <h4 className='mb-[10px] font-spaceGrotesk'>Autonomous communications</h4>
                  <p className='mb-7 last:mb-0 font-spaceGrotesk-light'>
                    Logpilot will communicate with suppliers proactively and gather 
                    information such as delivery delays, production disruptions, and transport disruptions to better plan procurement process.
                    
                  </p>
                </li>
                <li>
                  <h4 className='mb-[10px] font-spaceGrotesk'>
                    Document processing
                  </h4>
                  <p className='mb-7 last:mb-0 font-spaceGrotesk-light'>
