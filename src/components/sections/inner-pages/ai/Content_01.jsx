            ...
            <div className='jos order-1' data-jos_animation='fade-right'>
              ...
              <div className='text-lg leading-[1.4] lg:text-[20px] font-inter'>
                <p className='mb-7 last:mb-0'>
                 Let logpilot take care of your supply chain requirements. Logpilot 
              ...
              <ul className='mt-8 grid gap-x-6  gap-y-8 sm:grid-cols-2 md:grid-cols-1 xl:mt-14 xl:grid-cols-2'>
                <li className='flex flex-col gap-y-4 '>
                  <div className='h-[50px] w-[50px] font-satoshi'>
                    <img
                  ...
                  <h5 classname= 'font-inter'>Less stock-outs</h5>
                ...
                <li className='flex flex-col gap-y-4'>
                  ...
                  <h5 classname= 'font-inter'>Improved efficiency</h5>
                  <p className='text-lg font-inter'>
