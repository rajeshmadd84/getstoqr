...
const Service_Section = () => {
  return (
    <section id='section-service'>
      {/* Section Spacer */}
      <div className='pt-20 pb-20 xl:pb-[150px] bg-colorLinenRuffle'>
        {/* Section Container */}
        <div className='global-container'>
          {/* Section Content Block */}
          <div className='jos mb-10 text-center lg:mb-16 xl:mb-20'>
            <div className='mx-auto max-w-md lg:max-w-xl xl:max-w-[950px] text-colorBlue'>
              <h2>Why Choose Logpilot?</h2>
            </div>
          </div>
          {/* Section Content Block */}
          {/* Service List */}
