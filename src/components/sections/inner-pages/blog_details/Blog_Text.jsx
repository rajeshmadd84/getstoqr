...
const Blog_Text = () => {
  return (
    <article className='jos overflow-hidden bg-white'>
      ...
      Welcome to Logpilot, owned by Krutrima Medho OÜ (“Company,” “we,” “us,” or “our”). By accessing or using our software-as-a-service (SaaS) platform (the “Service”), you agree to comply with and be bound by these Terms of Service (“Terms”). 
      ...
      <ul className='mb-7 flex flex-col gap-7 last:mb-0'>
        ...
        <li>
          ...
          <p className='mb-7 last:mb-0'>
          Krutrima Medho OÜ is committed to ensuring that all personal data of users located in the European Union (EU) is stored exclusively within the EU. 
      ...
      <p className='mb-7 last:mb-0'>
      As an Estonian company, Krutrima Medho OÜ and its Logpilot platform comply with the General Data Protection Regulation (GDPR). 
      ...
      <ul className='mb-7 flex flex-col gap-7 last:mb-0'>
        ...
        <li>
          ...
          <p className='mb-7 last:mb-0'>
          All intellectual property rights in the platform, including but not limited to software, design, databases, and content, belong to Krutrima Medho OÜ or its licensors. 
        ...
        <li>
          ...
          To the maximum extent permitted by law, Krutrima Medho OÜ will not be liable for any indirect, incidental, punitive, or consequential damages arising from your use of or inability to use Logpilot. 
          In no event will Krutrima Medho OÜ’s aggregate liability exceed the fees paid by you to use the platform during the 12 months preceding the claim.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p className='mb-7 last:mb-0'>
          These Terms are governed by and construed in accordance with the laws of Estonia. Any disputes arising from these Terms or your use of the platform will be subject to the exclusive jurisdiction of the Estonian courts.
          </p>
        </li>
      </ul>
    </article>
