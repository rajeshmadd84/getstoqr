              ...
              <div className='mx-auto max-w-[910px] text-center'>
                ...
                <div className='block rounded-lg bg-white px-[30px] py-[50px] text-left shadow-[0_4px_60px_0_rgba(0,0,0,0.1)] sm:px-10'>
                  ...
                  >
                    ...
                    <button
                      type='submit'
                      className='button mt-7 block rounded-[10px] border-1 border-black bg-black py-4 text-white after:bg-colorOrangyRed hover:border-colorOrangyRed hover:text-white'
                    >
                      Sign in
                    </button>
                    {/* Form Group */}
                  ...
                  <div className='flex flex-col gap-y-6'>
                    ...
                    <a className='button flex w-full justify-center gap-x-4 rounded-[10px] border-2 border-[#EAEDF0] bg-white py-4 hover:bg-slate-200 cursor-pointer'>
